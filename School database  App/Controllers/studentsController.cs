...
namespace School_database__App.Controllers
{
    public class studentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Student_id,FirstName")] student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Student_id,FirstName")] student student)
        {
